            ...
            <div class="community__left">
                <div class="forum">
                    ...
                    <div class="forum__post">
                        ...
                        <h6 class="forum__post-details">posted 8 days ago by: <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-default.jpg" alt="User Image" class="forum__user-img"><span tabindex="0">barnOwl_56</span></h6>
                    ...
                    <div class="forum__post">
                        ...
                        <h6 class="forum__post-details">posted 2 days ago by: <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-9.jpg" alt="User Image" class="forum__user-img"><span tabindex="0">buckshot</span></h6>
                    ...
                    <div class="forum__post">
                        ...
                        <h6 class="forum__post-details">posted 5 days ago by: <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-default.jpg" alt="User Image" class="forum__user-img"><span tabindex="0">city2farm</span></h6>
                    ...
                    <div class="forum__post">
                        ...
                        <h6 class="forum__post-details">posted yesterday by: <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-1.jpg" alt="User Image" class="forum__user-img"><span tabindex="0">LeeroyJenkinz</span></h6>
            ...
            <div class="community__right">    
                ...
                <div class="members">
                    ...
                    <ul class="members__list">
                        <li class="members__user" tabindex="0">1. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-1.jpg" alt="User Image" class="members__img"> LeeroyJenkinz <span>206</span></li>

                        <li class="members__user" tabindex="0">2. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-2.jpg" alt="User Image" class="members__img"> whisky_n_powder <span>183</span></li>

                        <li class="members__user" tabindex="0">3. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-3.jpg" alt="User Image" class="members__img"> oldcatlady <span>179</span></li>

                        <li class="members__user" tabindex="0">4. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-4.jpg" alt="User Image" class="members__img"> TriggerWarning <span>142</span></li>

                        <li class="members__user" tabindex="0">5. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-5.jpg" alt="User Image" class="members__img"> deere_green69 <span>137</span></li>

                        <li class="members__user" tabindex="0">6. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-6.jpg" alt="User Image" class="members__img"> crazyJoe <span>111</span></li>

                        <li class="members__user" tabindex="0">7. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-default.jpg" alt="User Image" class="members__img"> shroomguy83 <span>109</span></li>

                        <li class="members__user" tabindex="0">8. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-7.jpg" alt="User Image" class="members__img"> moldy_pickle <span>88</span></li>

                        <li class="members__user" tabindex="0">9. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-default.jpg" alt="User Image" class="members__img"> city2farm <span>81</span></li>

                        <li class="members__user" tabindex="0">10. <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/user-8.jpg" alt="User Image" class="members__img"> njgorton <span>75</span></li>
                    </ul>
